...
<form action="{{ route("admin.publications.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('titre') ? 'has-error' : '' }}">
                ...
                <input type="hidden" name="typedocument" id="titre" class="form-control" value="Article" />
                 @if($errors->has('typedocument'))
                    <p class="help-block">
                        {{ $errors->first('typedocument') }}
                    </p>
...
<div class="form-group {{ $errors->has('titre') ? 'has-error' : '' }}">
                ...
                <input type="hidden" name="typedocument" id="titre" class="form-control" value="livre" />
                 @if($errors->has('typedocument'))
                    <p class="help-block">
                        {{ $errors->first('typedocument') }}
                    </p>
...
<div class="form-group {{ $errors->has('titre') ? 'has-error' : '' }}">
                ...
                <input type="hidden" name="typedocument" id="titre" class="form-control" value="conférence" />
                 @if($errors->has('typedocument'))
                    <p class="help-block">
                        {{ $errors->first('typedocument') }}
                    </p>
...
<div class="form-group {{ $errors->has('titre') ? 'has-error' : '' }}">
                ...
                <input type="hidden" name="typedocument" id="titre" class="form-control" value="Chapitre" />
                 @if($errors->has('typedocument'))
                    <p class="help-block">
                        {{ $errors->first('typedocument') }}
                    </p>
...
<div class="form-group {{ $errors->has('titre') ? 'has-error' : '' }}">
                ...
                <input type="hidden" name="typedocument" id="titre" class="form-control" value="HDR" />
                 @if($errors->has('typedocument'))
                    <p class="help-block">
                        {{ $errors->first('typedocument') }}
                    </p>
...
<div class="form-group {{ $errors->has('titre') ? 'has-error' : '' }}">
                ...
                <input type="hidden" name="typedocument" id="titre" class="form-control" value="REPORTmaster" />
                 @if($errors->has('typedocument'))
                    <p class="help-block">
                        {{ $errors->first('typedocument') }}
                    </p>
...
<div class="form-group {{ $errors->has('titre') ? 'has-error' : '' }}">
                ...
                <input type="hidden" name="typedocument" id="titre" class="form-control" value="THESE" />
                 @if($errors->has('typedocument'))
                    <p class="help-block">
                        {{ $errors->first('typedocument') }}
                    </p>
